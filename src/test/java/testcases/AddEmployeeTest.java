...
public class AddEmployeeTest extends CommonMethods {
    ...
    public void addEmployee(){
        ...
        sendText(addEmployeePage.firstName, "test90901");
        sendText(addEmployeePage.midName, "9090test1");
...
//navigate to add employee page
        ...
        while (it.hasNext()){
            ...
            sendText(addEmployeePage.midName, mapNewEmployee.get("MiddleName"));
            ...
            sendText(addEmployeePage.reEnterPassword, mapNewEmployee.get("Password"));
            click(addEmployeePage.saveBtn);
